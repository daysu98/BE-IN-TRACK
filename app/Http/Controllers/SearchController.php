    ...
    public function search(): JsonResponse
    {
        $search = User::when(
            ...
            $w->where('name', 'like', "%$this->q%")
                ...
                ->orWhereRelation('intern_attends', 'tanggal_iso', 'like', "%$this->q%")
                ...
                ->orWhereRelation('job_interns', 'deadline_iso', 'like', "%$this->q%")
                ...
                ->orWhereRelation('temp_intern_attends', 'tanggal_iso', 'like', "%$this->q%")
                ...
                ->orWhereRelation('temp_job_interns', 'deadline_iso', 'like', "%$this->q%")
